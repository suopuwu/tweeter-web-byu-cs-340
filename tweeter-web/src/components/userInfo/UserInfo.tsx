...
const UserInfo = () => {
    ...
    const getIsFollowerStatus = async (authToken: AuthToken, user: User, selectedUser: User): Promise<boolean> => {
    ...
    const getFolloweesCount = async (authToken: AuthToken, user: User): Promise<number> => {
        // TODO: Replace with the result of calling server
    ...
    const getFollowersCount = async (authToken: AuthToken, user: User): Promise<number> => {
        // TODO: Replace with the result of calling server
    ...
    const followDisplayedUser = async (event: React.MouseEvent): Promise<void> => {
        ...
        try {
            ...
            let [followersCount, followeesCount] = await follow(authToken!, displayedUser!)
    ...
    const unfollowDisplayedUser = async (event: React.MouseEvent): Promise<void> => {
        ...
        try {
            displayInfoMessage(`Removing ${displayedUser!.name} from followers...`, 0)

            let [followersCount, followeesCount] = await unfollow(authToken!, displayedUser!)
